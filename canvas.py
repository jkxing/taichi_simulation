...
class Canvas:
    def __init__(self, sizex, sizey):
        ...
        self.eye        = np.array([100.0, 100.0, 100.0])
    ...
    def static_cam(self, targetx, targety, targetz):
        ...
        self.target[1] = targety
        self.target[2] = targetz
        self.set_view_point(math.pi/4, math.pi/4, 0.0, 100)
    ...
    def transform(self, v):
        screenP  = self.proj[0] @ self.view[0] @ ti.Vector([v.x, v.z, v.y, 1.0])
        screenP /= screenP.w
